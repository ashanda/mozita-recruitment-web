...
if (!function_exists('jobster_get_search_companies_form')):
    function jobster_get_search_companies_form($pos = 'top') {
        ...
        if ($pos == 'top') { ?>
            <div class="pxp-hero-form pxp-hero-form-round pxp-large mt-3 mt-lg-4">
                <form 
                    id="pxp-companies-page-search-form" 
                ...
                >
                    ...
                    <div class="col-12 col-lg">
                        ...
                        <div class="input-group mb-3 mb-lg-0">
                            ...
                            <input 
                                ...
                                placeholder="<?php esc_attr_e('Company Name or Keyword', 'jobster'); ?>"
                            >
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-auto">
                        <button>
                            <?php esc_html_e('Find Companies', 'jobster') ?>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="pxp-companies-list-side-filter">
                <div class="pxp-list-side-filter-header d-flex d-lg-none">
                    <div class="pxp-list-side-filter-header-label">
                        <?php esc_html_e('Search Companies', 'jobster'); ?>
                    </div>
                ...
                <div class="mt-4 mt-lg-0 d-lg-block pxp-list-side-filter-panel">
                    ...
                    >
                        ...
                        <div class="mt-3 mt-lg-4">
                            <button><?php esc_html_e('Find Companies', 'jobster') ?></button>
                        </div>
                    </form>
                </div>
            </div>
