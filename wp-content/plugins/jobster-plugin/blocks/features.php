        ...
        if (isset($data['title']) && $data['title'] != '') {
            $return_string .=
                '<h2 class="pxp-section-h2">
                                Countless jobs. Choose the best one for you.
                                </h2>';
        }
        if (isset($data['text']) && $data['text'] != '') {
            $return_string .=
                '<p class="pxp-text-light">
                Search the web for all open positions. Create your own customized salary estimate. Read reviews on over 600,000 applicants in  the world.
                                </p>';
        }
        if (isset($data['features']) && is_array($data['features'])) {
            ...
            <div class="pxp-info-caption-list-item">
                                        <img 
                                            ...
                                            alt="-"
                                        >
                                        <span>Bring a win-win situation to the table.
                                        </span>
                                    </div>
                                    <div class="pxp-info-caption-list-item">
                                        <img 
                                            ...
                                            alt="-"
                                        >
                                        <span>Take advantage of low-hanging fruit to identify</span>
                                    </div>
                                    <div class="pxp-info-caption-list-item">
                                        <img 
                                            src="' . esc_url(JOBSTER_PLUGIN_PATH . 'images/check.svg') . '" 
                                            alt="-"
                                        >
                                        <span>But first, let me explain how all of this works.</span>
                                    </div>
            ...
            $return_string .=
                '<div class="pxp-info-caption-cta">
                                <!--<a 
                                        ...
                                        href="https://recruitment.mozita.co.nz#pxp-signin-modal" 
