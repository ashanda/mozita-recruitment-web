...
$paypal_client_id = isset($membership_settings['jobster_paypal_client_id_field'])
                    ? $membership_settings['jobster_paypal_client_id_field']
                    : '';
$paypal_client_secret = isset($membership_settings['jobster_paypal_client_key_field'])
...
$payment_curency =  isset($membership_settings['jobster_payment_currency_field'])
                    ? $membership_settings['resideo_payment_currency_field']
                    : '';
