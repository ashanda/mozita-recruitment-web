    ...
    function jobster_job_apply_notify_company($job_id, $candidate_id, $anonymous_message = '') {
        ...
        if (!empty($company_id)) {
            ...
            if (!empty($company_email) && !empty($company_notify)) {
                ...
                $message = __('A new candidate has applied for your job', 'jobster')  . '<br /><br />';
                $message .= sprintf(__('Job title: %s', 'jobster'), esc_html($job_title)) . '<br />';
                $message .= sprintf(__('Candidate name: %s', 'jobster'), esc_html($candidate_name)) . '<br />';
                $message .= sprintf(__('Candidate email: %s', 'jobster'), esc_html($candidate_email)) . '<br /><br />';
