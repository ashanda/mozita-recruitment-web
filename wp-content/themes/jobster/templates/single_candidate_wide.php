...
while (have_posts()) : the_post();
    ...
    $system_id = get_post_meta($candidate_id, 'candidate_systemid', true);
                        ...
                        <div class="pxp-single-candidate-side-panel mt-5 mt-lg-0">
                                ...
                                if (!empty($email)) { ?>
                                    <div>
                                        ...
                                        <div class="pxp-single-candidate-side-info-data">
                                            ...
                                            <a href="mailto:employer@mozita.co.nz">
                                            employer@mozita.co.nz
                                            </a>
                                        </div>
                                    </div>
                                <?php }
                            ...
                            if (!empty($cv) && $show_download_btn) {
                                ...
                                <div class="mt-4">
                                        ...
                                        <button onclick="printFunction()" id="download_cv" class="btn rounded-pill d-block"><?php echo esc_html_e('Download Resume', 'jobster'); ?></button>
                                    <?php /*<form>
                                        <a 
