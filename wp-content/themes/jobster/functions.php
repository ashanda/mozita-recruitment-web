    ...
    function jobster_register_required_plugins() {
        $plugins = array(
            array(
                'name'         => 'Jobster Plugin',
                'slug'         => 'jobster-plugin',
                'source'       => 'https://pixelprime.co/themes/jobster-wp/plugins/jobster-plugin-1-3/jobster-plugin.zip',
                'required'     => true,
                'version'      => '1.3',
                'external_url' => ''
            ),
